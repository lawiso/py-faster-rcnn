...
./tools/train_net.py --gpu 0 --weights data/imagenet_models/VGG16.v2.caffemodel --imdb VEDAI_512_Train --cfg experiments/cfgs/vedai_512.yml --solver models/vedai/VGG16_anchor_3_scale_conv_3_3/faster_rcnn_end2end/solver.prototxt --iters 60000
