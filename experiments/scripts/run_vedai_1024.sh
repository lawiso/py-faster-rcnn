...
./tools/train_net.py --gpu 0 --weights models/initialization/VGG_ILSVRC_16_layers.caffemodel --imdb VEDAI_1024_Train --cfg experiments/cfgs/vedai_1024.yml --solver models/vedai/VGG16_anchor_3_scale_conv_3_3/faster_rcnn_end2end/solver.prototxt --iters 60000
